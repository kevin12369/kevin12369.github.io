...
export const siteConfig: SiteConfig = {
    // 站点 URL（以斜杠结尾）
    siteURL: "https://kevin12369.github.io/",
    // 站点标题
    title: "Kevin.AI",
    // 站点副标题
    subtitle: "探索AI增强型全栈开发的实践与思考",
    // 语言配置
    ...
    links: [
        ...
        LinkPreset.Archive,
        {
            ...
            children: [
                {
                    name: "前端开发",
                    url: "/content/?category=前端",
                },
                {
                    name: "AI全栈",
                    url: "/content/?category=AI全栈",
                },
                {
                    name: "算法",
                    url: "/content/?category=算法",
                },
                {
                    name: "物联网",
                    url: "/content/?category=物联网",
                },
            ],
        },
        {
...
export const announcementConfig: AnnouncementConfig = {
    ...
    title: "公告",
    // 公告内容
    content: "欢迎来到Kevin.AI博客！这里分享AI增强型全栈开发的实践与思考。",
    // 允许用户关闭公告
    closable: true,
    // 链接配置
    link: {
