...
<p>在本文中我们将会深挖 AST（抽象语法树）以及基于 AST 衍生出来的一系列实际应用。
读完本章你会收获什么：</p>
<ul>
...
<p>先将源代码转化成 <code v-pre>AST</code>
遍历 <code v-pre>AST</code> 上的节点，找到 <code v-pre>hello</code> 函数名节点并修改
将转换过的 <code v-pre>AST</code> 再生成 <code v-pre>JS</code> 代码
