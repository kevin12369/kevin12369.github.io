<template><div><h1 id="html-css-常见面试题总结" tabindex="-1"><a class="header-anchor" href="#html-css-常见面试题总结" aria-hidden="true">#</a> HTML&amp;CSS 常见面试题总结</h1>
<p><a href="https://juejin.cn/post/7175048315111735352" target="_blank" rel="noopener noreferrer">参考自掘金《2023 前端面试系列--HTML &amp; CSS 篇》<ExternalLinkIcon/></a><br>
<a href="https://juejin.cn/post/7061588533214969892" target="_blank" rel="noopener noreferrer">参考自掘金《做了一份前端面试复习计划，保熟～》<ExternalLinkIcon/></a><br>
<a href="https://juejin.cn/post/7016593221815910408" target="_blank" rel="noopener noreferrer">参考自掘金《连八股文都不懂还指望在前端混下去么》<ExternalLinkIcon/></a><br>
<a href="https://juejin.cn/post/6844904115428917255" target="_blank" rel="noopener noreferrer">参考自掘金《写给女朋友的中级前端面试秘籍（含详细答案，15k 级别）》<ExternalLinkIcon/></a><br>
<a href="https://blog.csdn.net/by6671715/article/details/127599870" target="_blank" rel="noopener noreferrer">参考自 CSDN《[前端基础] HTML5 篇》<ExternalLinkIcon/></a></p>
<h2 id="html" tabindex="-1"><a class="header-anchor" href="#html" aria-hidden="true">#</a> HTML</h2>
<h2 id="语义化" tabindex="-1"><a class="header-anchor" href="#语义化" aria-hidden="true">#</a> 语义化</h2>
<ol>
<li>语义化，指对文本内容的结构化（内容语义化），选择合乎语义的标签（代码语义化）。</li>
<li>语义化标签：<code v-pre>header</code>、<code v-pre>nav</code>、<code v-pre>main</code>、<code v-pre>article</code>、<code v-pre>section</code>、<code v-pre>aside</code>、<code v-pre>footer</code>等。</li>
<li>优点：</li>
</ol>
<ul>
...
<p>建议阅读文章：<a href="https://rainylog.com/post/ife-note-1/" target="_blank" rel="noopener noreferrer">百度 IFE 的 H5 语义化文章<ExternalLinkIcon/></a></p>
<h2 id="script-标签中属性-async-和-defer-的区别" tabindex="-1"><a class="header-anchor" href="#script-标签中属性-async-和-defer-的区别" aria-hidden="true">#</a> script 标签中属性 async 和 defer 的区别？</h2>
<ul>
<li><code v-pre>script</code>：会阻碍 HTML 解析，只有下载好并执行完脚本才会继续解析 HTML。</li>
<li><code v-pre>async script</code>：解析 HTML 的过程中会进行脚本的异步下载，下载成功后立马执行，因此有可能会阻断 HTML 的解析。多个脚本的执行循序无法保证。</li>
<li><code v-pre>defer script</code>：也是异步下载脚本，加载完成后，如果此时 HTML 还没有解析完，浏览器不会暂停解析去执行 JS 代码，而是等待 HTML 解析完毕再执行 JS 代码，如果存在多个<code v-pre>defer script</code>标签，浏览器（IE9 及以下除外）会保证它们按照在 HTML 中出现的顺序执行，不会破坏 JS 脚本之间的依赖关系。</li>
</ul>
<p>建议阅读文章：<a href="https://juejin.cn/post/6894629999215640583" target="_blank" rel="noopener noreferrer">图解 script 标签中的 async 和 defer 属性<ExternalLinkIcon/></a></p>
<h2 id="doctype-的作用是什么" tabindex="-1"><a class="header-anchor" href="#doctype-的作用是什么" aria-hidden="true">#</a> DOCTYPE 的作用是什么？</h2>
<p><code v-pre>&lt;!DOCTYPE&gt;</code>声明一般位于文档的第一行，它的作用主要是告诉浏览器以什么样的模式来解析文档。一般指定了之后会以“标准模式”进行文档解析，否则就以“兼容模式”进行解析。</p>
<ul>
<li>在<code v-pre>标准模式</code>下，浏览器的解析规则都是按照最新的标准进行解析的。</li>
<li>而在<code v-pre>兼容模式</code>下，浏览器会以向后兼容的方式来模拟老式浏览器的行为，以保证一些老的网站能正常访问。</li>
</ul>
<h2 id="sgml、html、xml-和-xhtml-的区别" tabindex="-1"><a class="header-anchor" href="#sgml、html、xml-和-xhtml-的区别" aria-hidden="true">#</a> SGML、HTML、XML 和 XHTML 的区别？</h2>
<ul>
<li><code v-pre>SGML</code>是标准通用标记语言，是一种定义电子文档结构和描述其内容的伙计标准语言，是所有电子文档标记语言的起源。</li>
<li><code v-pre>HTML</code>是超文本标记语言，主要是用于规定怎样显示网页。</li>
<li><code v-pre>XML</code>是可拓展标记语言，是未来网页语言的发展方向，XML 和 HTML 的最大区别就在于 XML 的标签是可以自己创建的，数量无限多，而 HTML 的标签都是固定的而且数量有限。</li>
<li><code v-pre>XHTML</code>也是现在基本上搜友网页都在用的标记语言，他起始和 HTML 没什么本质的区别，标签都一样，用法也都一样，就是比 HTML 更严格，比如标签必须都用小写，标签都必须有闭合标签等。</li>
</ul>
<h2 id="html5-有哪些新特性、移除了哪些元素" tabindex="-1"><a class="header-anchor" href="#html5-有哪些新特性、移除了哪些元素" aria-hidden="true">#</a> HTML5 有哪些新特性、移除了哪些元素？</h2>
<p>HTML5 现在已经不是 SGML 的子集，主要是关于图像、位置存储、多任务等功能的增加。</p>
<p>新增的：</p>
<ul>
<li>绘图<code v-pre>canvas</code></li>
<li>用于媒介回放的<code v-pre>video</code>和<code v-pre>audio</code>元素</li>
<li>本地离线存储<code v-pre>localStorage</code>、<code v-pre>sessionStorage</code></li>
<li>语义化更好的内容元素，如：<code v-pre>header</code>、<code v-pre>article</code>、<code v-pre>nav</code>、<code v-pre>section</code>、<code v-pre>footer</code>等</li>
<li>表单控件<code v-pre>calender</code>、<code v-pre>date</code>、<code v-pre>time</code>、<code v-pre>email</code>、<code v-pre>url</code>、<code v-pre>search</code>等</li>
<li>新的技术<code v-pre>webworker</code>、<code v-pre>websocket</code></li>
<li>新的文档属性<code v-pre>document.visibilityState</code></li>
</ul>
<p>移除的：</p>
<ul>
<li>纯表现的元素：<code v-pre>basefont</code>、<code v-pre>big</code>、<code v-pre>center</code>、<code v-pre>s</code>、<code v-pre>tt</code>、<code v-pre>u</code></li>
<li>对可用性产生负面影响的元素：<code v-pre>frame</code>、<code v-pre>frameset</code>、<code v-pre>noframes</code></li>
</ul>
<h2 id="对浏览器内核的理解" tabindex="-1"><a class="header-anchor" href="#对浏览器内核的理解" aria-hidden="true">#</a> 对浏览器内核的理解？</h2>
<p>主要分为两个部分:渲染引擎和 JS 引擎</p>
<ul>
<li>
<p>渲染引擎：其职责就是渲染,即在浏览器窗口中显示所请求的内容。默认情况下，渲染引擎可以显示 HTML、XML 文档及图片，它也可以借助一些浏览器扩展插件显示其他类型数据，如：使用 PDF 阅读器插件可以显示 PDF 格式。</p>
</li>
<li>
...
<p>JS 是面向对象的，每个实例对象都有一个<code v-pre>__proto__</code>属性，概述想指向它的<code v-pre>原型</code>对象。该实例的构造函数有一个原型属性<code v-pre>prototype</code>，与实例的<code v-pre>__proto__</code>属性指向同一个对象。同时，原型对象的<code v-pre>constructor</code>指向构造函数本身。</p>
<p><a href="./images/%E5%AF%B9%E8%B1%A1%E5%8E%9F%E5%9E%8B.png" title="对象原型">对象原型</a></p>
<p>当一个对象在查找一个属性时，自身没有就会根据<code v-pre>__proto__</code>属性向它的<code v-pre>原型</code>进行查找，如果还是没有，则向它的<code v-pre>原型</code>的<code v-pre>原型</code>继续查找，直至查到<code v-pre>Object.prototype.__proto__</code>也就是<code v-pre>null</code>，这样就形成了<code v-pre>原型链</code>。</p>
<p>推荐阅读：<a href="https://juejin.cn/post/6844903989088092174" target="_blank" rel="noopener noreferrer">轻松理解 JS 原型和原型链<ExternalLinkIcon/></a></p>
<h2 id="闭包" tabindex="-1"><a class="header-anchor" href="#闭包" aria-hidden="true">#</a> 闭包？</h2>
<p>在 JavaScript 中，每当创建一个函数，闭包就会在函数创建的同时被创建出来。可以在一个内层函数中访问到其外层函数的作用域。<br>
闭包就是能够读取其他函数内部变量的函数。主要作用是解决变量污染问题，也可以用来延长局部变量的生命周期。<br>
优点：延长局部变量的生命周期<br>
缺点：会导致函数的变量一直保存在内存中，过多的闭包可能会导致内存泄漏<br>
推荐阅读：<a href="https://juejin.cn/post/6844903858636849159" target="_blank" rel="noopener noreferrer">我从来不理解 JavaScript 闭包，直到有人这样向我解释它<ExternalLinkIcon/></a></p>
<h2 id="new-操作符的实现机制" tabindex="-1"><a class="header-anchor" href="#new-操作符的实现机制" aria-hidden="true">#</a> new 操作符的实现机制？</h2>
<ol>
<li>首先创建了一个新的<code v-pre>空对象</code></li>
<li><code v-pre>设置原型</code>，将对象的原型设置为函数的<code v-pre>prototype</code>对象</li>
<li>让函数的<code v-pre>this</code>指向这个对象，执行构造函数的代码（为这个对象添加属性）</li>
<li>判断函数的返回值类型，如果是值类型，返回创建的对象。如果是引用类型，就返回这个引用类型的对象。</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">myNew</span><span class="token punctuation">(</span><span class="token parameter">context</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="this-的理解" tabindex="-1"><a class="header-anchor" href="#this-的理解" aria-hidden="true">#</a> this 的理解？</h2>
<ol>
<li>概念：<br>
<code v-pre>this</code>是 JS 的一个关键字，它是函数运行时，自动生成的一个内部对象，只能在函数内部使用，随着函数使用场合的不同，<code v-pre>this</code>的值会发生变化，但有一个总的原则：<code v-pre>this指的是调用函数的那个对象</code>。</li>
<li>this 的指向：
<ul>
<li>作为普通函数执行时，<code v-pre>this</code> 指向 <code v-pre>window</code>，但在严格模式下 <code v-pre>this</code> 指向 <code v-pre>undefined</code>。</li>
<li>函数作为对象里的方法被调用时，<code v-pre>this</code> 指向该对象。</li>
<li>当用<code v-pre>new</code>运算符调用构造函数时，<code v-pre>this</code>指向返回的这个对象。</li>
<li>箭头函数的<code v-pre>this</code>绑定看的是<code v-pre>this</code>所在函数定义函数定义在哪个对象下，就绑定哪个对象。如果存在嵌套，则<code v-pre>this</code>绑定到最近的一层对象上。</li>
<li><code v-pre>call()</code>、<code v-pre>apply()</code>、<code v-pre>bind()</code>是函数的三个方法，都可以显示的指定调用函数的 <code v-pre>this</code> 指向。</li>
</ul>
</li>
</ol>
<h2 id="call、apply、bind-的区别以及手写实现" tabindex="-1"><a class="header-anchor" href="#call、apply、bind-的区别以及手写实现" aria-hidden="true">#</a> call、apply、bind 的区别以及手写实现</h2>
<ul>
<li><code v-pre>call()</code>可以传递两个参数，第一个参数是指定函数内部中 <code v-pre>this</code> 的指向，第二个参数是函数调用时需要传递的参数。改变<code v-pre>this</code>指向后原函数会立即执行，且此方法只是临时改变<code v-pre>this</code>指向一次。</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 实现call方法</span>
...
<li><code v-pre>apply()</code>接受两个参数，第一个参数是 this 的指向，第二个参数是函数接受的参数，以<code v-pre>数组</code>的形式传入。改变 <code v-pre>this</code> 指向后原函数会立即执行,且此方法只是临时改变 <code v-pre>this</code> 指向一次。</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 实现apply方法</span>
...
<li><code v-pre>bind()</code>方法的第一参数也是 <code v-pre>this</code> 的指向，后面窜如的也是一个参数列表（但是这个参数列表可以分多次传入）。改变 <code v-pre>this</code> 指向后不会立即执行，而是返回一个永久改变 <code v-pre>this</code> 指向的函数。</li>
</ul>
...
<ul>
<li>
<p><code v-pre>call()</code>和 <code v-pre>bind()</code>第二个参数是列表形式的；<code v-pre>apply()</code>第二个参数是数组形式。</p>
</li>
<li>
<p><code v-pre>call()</code>和 <code v-pre>apply()</code>是立即执行；<code v-pre>bind()</code>不会立即执行而是生成一个修改 <code v-pre>this</code> 之后的新函数</p>
</li>
</ul>
<h2 id="箭头函数" tabindex="-1"><a class="header-anchor" href="#箭头函数" aria-hidden="true">#</a> 箭头函数？</h2>
<ol>
<li>箭头函数时定义函数一种新的方式，比普通函数定义更加方便和简单。</li>
<li>箭头函数不绑定 <code v-pre>this，会捕获其所在上下文的</code> <code v-pre>this</code>，作为自己的 <code v-pre>this</code>。</li>
<li>箭头函数不能用作构造函数，也就是说不可以使用 <code v-pre>new</code> 命令，否则会抛出错误。</li>
<li>箭头函数不绑定 <code v-pre>arguments</code>，取而代之用 <code v-pre>rest</code> 参数解决，同时没有 <code v-pre>super</code> 和 <code v-pre>new.target</code>。</li>
<li>使用 <code v-pre>call</code>,<code v-pre>apply</code>,<code v-pre>bind</code> 并不会改变箭头函数中的 <code v-pre>this</code> 指向。对箭头函数使用 <code v-pre>call</code> 或 <code v-pre>apply</code> 方法时，只会传入参数并调用函数；对箭头函数使用 <code v-pre>bind</code> 方法时，只会返回一个预设参数的新函数，并不会改变这个新函数的 <code v-pre>this</code> 指向。</li>
</ol>
<h2 id="浅拷贝和深拷贝的实现" tabindex="-1"><a class="header-anchor" href="#浅拷贝和深拷贝的实现" aria-hidden="true">#</a> 浅拷贝和深拷贝的实现？</h2>
<p><code v-pre>浅拷贝</code>：如果属性是基本类型，拷贝的就是基本类型的值；如果属性是引用类型，拷贝的就是内存地址。即浅拷贝是<code v-pre>拷贝一层</code>，深层次的引用类型则共享内存地址。常用的方法有：object.assign，扩展运算符等等</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>深拷贝</code>：开辟一个新的栈，两个对象的属性完全相同，但是对应两个不同的地址，修改一个对象的属性，不会改变另一个对象的属性。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="javascript-中内存泄漏的几种情况" tabindex="-1"><a class="header-anchor" href="#javascript-中内存泄漏的几种情况" aria-hidden="true">#</a> JavaScript 中内存泄漏的几种情况？</h2>
<p>内存泄漏一般是指系统进程不在用到的内存，没有及时释放，造成内存资源的浪费，导致程序运行速度慢甚至西永崩溃等严重后果。</p>
<p>造成内存泄漏的原因有：</p>
<ol>
<li>
<p><code v-pre>全局变量。</code>在局部作用域中，函数执行完毕后，变量就没有存在的必要了，垃圾回收机制很快的做出判断并回收；但是对于全局变量，很难判断什么时候不用这些变量，无法正常回收。</p>
<ul>
<li>解决办法：
<ul>
<li>尽量少使用全局变量</li>
<li>使用严格模式，在 js 文件头部或者函数的顶部加上<code v-pre>use strict</code>。</li>
</ul>
</li>
</ul>
</li>
<li>
<p><code v-pre>闭包引起的内存泄漏。</code>闭包可以读取函数内部的变量，然后让这些变量始终保存在内存中，如果在使用结束后没有将局部变量清除，就可能导致内存泄漏。</p>
<ul>
<li>解决办法：将事件处理函数定义在外部，解除闭包。</li>
</ul>
</li>
<li>
<p><code v-pre>被遗忘的定时器。</code>定时器 <code v-pre>setInterval</code> 或者 <code v-pre>setTimeout</code> 不再需要使用时，且没有被清除，导致定时器的回调函数及其内部依赖的变量都不能被回收，就会造成内存泄漏。</p>
<ul>
<li>解决办法：当不需要定时器的时候，调用 <code v-pre>clearInterval</code> 或者 <code v-pre>clearTimeout</code> 手动清除。</li>
</ul>
</li>
<li>
<p><code v-pre>事件监听。</code>垃圾回收机制不好判断事件是否需要被解除，导致 <code v-pre>callback</code> 不能被释放，此时需要手动解除绑定。</p>
<ul>
<li>解决办法：及时使用 <code v-pre>removeEventlistener</code> 移除事件监听。</li>
</ul>
</li>
<li>
<p><code v-pre>元素引用没有清理。</code></p>
<ul>
<li>解决办法：移除元素后，手动设置元素的引用为 <code v-pre>null</code>。</li>
</ul>
</li>
<li>
<p><code v-pre>console。</code>传递给 <code v-pre>console.log</code> 的对象是不能被垃圾回收，可能会存在内存泄漏。</p>
<ul>
<li>解决办法：清除不必要的 <code v-pre>console</code>。</li>
</ul>
</li>
</ol>
<h2 id="防抖和节流的区别-以及手写实现" tabindex="-1"><a class="header-anchor" href="#防抖和节流的区别-以及手写实现" aria-hidden="true">#</a> 防抖和节流的区别，以及手写实现？</h2>
<p><code v-pre>防抖</code>：多次触发事件，事件处理函数只执行一次，并且是在触发操作结束时执行。也就是说，当一个事件被触发，准备执行事件函数前，会等待一定的时间，在这个等待时间内，如果，如果没有再次被触发，那么就执行这个事件函数；如果又触发了，那么本次动作作废，重置等待时间，直到最终能执行为止。</p>
<p>主要应用场景：搜索框搜索输入，用户最后一次输入完成后，再发送请求；手机号邮箱严重输入检测。</p>
<p><code v-pre>节流</code>：事件触发后，规定时间内，事件处理函数不能再次被调用。也就是说在规定的时间内，函数只能被调用一次，切实最先被出发调用的那次。</p>
<p>主要是应用场景：高频点击、表单重复提交等。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 函数类型：防抖函数
...
<p>js 是单线成运行的，当遇到一个异步事件后并不会一直等待其返回结果，而是会将这个事件挂起，继续执行 执行栈中的其他任务。当一个异步事件返回结果后，js 会将这个事件加入与当前执行栈不同的另一个队列--<code v-pre>事件队列(Task Queue)</code>。被放入事件队列不会立即执行其回调，而是等待当前执行栈中所有任务都执行完毕，主程序处于闲置状态时，主线程会去查找事件队列中是否有任务，如果有，那么主线程会从中取出排在第一位的事件，并把这个事件对应的回调放入执行栈中，然后执行其中的同步代码...，如此反复，遮掩就形成了一个无限的循环，这个过程被称为<code v-pre>事件循环(Event Loop)</code>。</p>
<p>实际上，异步任务之间并不相同，他们的执行优先级也有区别。一步任务分两类：<code v-pre>微任务(micro task)</code>和 <code v-pre>宏任务(macro task)</code>。</p>
<p>微任务包括：<code v-pre>promise</code> 的回调、node 中的 <code v-pre>process.nextTick</code>、对 Dom 变化监听的 <code v-pre>MutationObserver</code>。</p>
<p>宏任务包括：script 脚本的执行，setTimeout、setInterval 和 setImmediate 一类的定时事件，还有 I/O 操作，UI 渲染等。</p>
<p>在一个事件循环中，异步事件返回结果后会被放到一个时间队列中。然而，根据这个异步事件的类型，这个事件实际上会被对应的<code v-pre>宏任务队列</code>或者<code v-pre>微任务队列</code>中去。并且在当前执行栈为空的时候，主线程会查看微任务队列是否事件存在。如果不存在，那么再去宏任务队列中取出一个事件并把对应的回调加入当前执行栈；如果存在，则会依次执行队列中事件对应的回调，直到微任务队列为空，然后去宏任务队列中取出最前面的一个事件，把对应的回调加入当前执行栈...如此反复，进入循环。</p>
<p><strong>在当前执行栈执行完毕时会立刻先处理所有微任务队列中的事件，然后再去宏任务队列中取出一个事件。同一次事件循环中，微任务永远在宏任务之前执行。</strong></p>
<p>推荐阅读：</p>
<p><a href="https://zhuanlan.zhihu.com/p/33058983" target="_blank" rel="noopener noreferrer">详解 JavaScript 中的 Event Loop（事件循环）机制<ExternalLinkIcon/></a></p>
<p><a href="https://juejin.cn/post/6844903657264136200" target="_blank" rel="noopener noreferrer">微任务、宏任务与 Event-Loop<ExternalLinkIcon/></a></p>
<h2 id="promise" tabindex="-1"><a class="header-anchor" href="#promise" aria-hidden="true">#</a> Promise？</h2>
<p><code v-pre>Promise</code> 异步编程的一种解决方案。<code v-pre>Promise</code> 是一个构造函数，接收一个函数作为参数，返回一个 Promise 实例。一个 Promise 实例有三种状态，分别是 <code v-pre>pending</code>（初始状态）、<code v-pre>fulfilled</code>（成功的操作） 和 <code v-pre>rejected</code>（失败的操作），分别代表了进行中、已成功和已失败。实例的状态只能由 pending 转变 fulfilled 或者 rejected 状态，并且状态一经改变，就无法再改变了。状态的改变是通过 <code v-pre>resolve()</code>和 <code v-pre>reject()</code>函数来实现的，可以在异步操作结束后调用这两个函数改变 Promise 实例的状态。Promise 的原型上定义了一个 <code v-pre>then()</code> 方法，使用这个 then 方法可以为两个状态的改变注册回调函数。这个回调函数属于微任务，会在本轮事件循环的末尾执行。</p>
<p>推荐阅读：</p>
<p><a href="https://es6.ruanyifeng.com/#docs/promise" target="_blank" rel="noopener noreferrer">Promise 对象<ExternalLinkIcon/></a></p>
<p><a href="https://juejin.cn/post/6844903607968481287" target="_blank" rel="noopener noreferrer">Promise 不会？看这里！！！史上最通俗易懂的 Promise！！！<ExternalLinkIcon/></a></p>
<p><a href="https://mp.weixin.qq.com/s/qdJ0Xd8zTgtetFdlJL3P1g" target="_blank" rel="noopener noreferrer">100 行代码实现 Promises/A+规范<ExternalLinkIcon/></a></p>
<p>参考链接</p>
<p><a href="https://juejin.cn/post/7016593221815910408" target="_blank" rel="noopener noreferrer">连八股文都不懂还指望在前端混下去么<ExternalLinkIcon/></a></p>
<p><a href="https://juejin.cn/post/7061588533214969892" target="_blank" rel="noopener noreferrer">做了一份前端面试复习计划，保熟~<ExternalLinkIcon/></a></p>
</div></template>
