<template><div><h1 id="在-ubuntu-linux-中部署-thingsboard" tabindex="-1"><a class="header-anchor" href="#在-ubuntu-linux-中部署-thingsboard" aria-hidden="true">#</a> 在 Ubuntu（Linux）中部署 ThingsBoard</h1>
