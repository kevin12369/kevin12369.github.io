import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,d as s,o as l}from"./app-ry7nqkQQ.js";const d={};function r(a,e){return l(),n("div",null,[...e[0]||(e[0]=[s(`<h1 id="前端技术学习-vue-axios全局接口防抖节流封装-2025版" tabindex="-1"><a class="header-anchor" href="#前端技术学习-vue-axios全局接口防抖节流封装-2025版" aria-hidden="true">#</a> 前端技术学习 - Vue+Axios全局接口防抖节流封装（2025版）</h1><h2 id="为什么需要防抖和节流" tabindex="-1"><a class="header-anchor" href="#为什么需要防抖和节流" aria-hidden="true">#</a> 为什么需要防抖和节流？</h2><p>在实际开发中，我们经常会遇到以下场景：</p><ol><li><strong>搜索框输入</strong>：用户输入时触发搜索请求</li><li><strong>按钮点击</strong>：用户快速点击提交按钮</li><li><strong>滚动加载</strong>：页面滚动时触发加载更多</li><li><strong>窗口调整</strong>：窗口大小改变时触发布局计算</li></ol><p>如果不进行处理，可能会导致：</p><ul><li>大量重复请求，浪费服务器资源</li><li>页面卡顿，影响用户体验</li><li>数据不一致，产生错误结果</li></ul><p><strong>防抖</strong>和<strong>节流</strong>是解决这类问题的有效方案。</p><h2 id="防抖和节流的区别" tabindex="-1"><a class="header-anchor" href="#防抖和节流的区别" aria-hidden="true">#</a> 防抖和节流的区别</h2><h3 id="防抖-debounce" tabindex="-1"><a class="header-anchor" href="#防抖-debounce" aria-hidden="true">#</a> 防抖（Debounce）</h3><p><strong>定义</strong>：在事件被触发 n 秒后再执行回调，如果在这 n 秒内又被触发，则重新计时。</p><p><strong>特点</strong>：</p><ul><li>多次触发，只执行最后一次</li><li>适合搜索框输入、窗口调整等场景</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>// 防抖函数
