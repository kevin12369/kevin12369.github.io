import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a as t,o}from"./app-BnzN889n.js";const a={};function s(l,e){return o(),i("div",null,[...e[0]||(e[0]=[t(`<h1 id="openai-api-接口文档-中文版" tabindex="-1"><a class="header-anchor" href="#openai-api-接口文档-中文版" aria-hidden="true">#</a> OpenAI-API 接口文档(中文版)</h1><h2 id="openai-api-中文版" tabindex="-1"><a class="header-anchor" href="#openai-api-中文版" aria-hidden="true">#</a> OpenAI-API-中文版</h2><h3 id="一、introduction介绍" tabindex="-1"><a class="header-anchor" href="#一、introduction介绍" aria-hidden="true">#</a> 一、<a href="https://platform.openai.com/docs/api-reference/introduction" target="_blank" rel="noopener noreferrer">Introduction</a>介绍</h3><p>如果你想使用我么你的 API，你可以通过 <strong>HTTP</strong> 请求从任何语言与 API 进行交互，也可以使用我们官方 Python 绑定、官方 Node.js 库或者使用<a href="https://platform.openai.com/docs/libraries/community-libraries" target="_blank" rel="noopener noreferrer">社区维护的库</a>。</p><p>若安装官方 Python 绑定，请运行一下命令：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>pip install openai
