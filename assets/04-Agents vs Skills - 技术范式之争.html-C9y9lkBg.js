...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-明确的元数据" tabindex="-1"><a class="header-anchor" href="#_2-明确的元数据" aria-hidden="true">#</a> 2. 明确的元数据</h4><p><strong>原则：</strong> 元数据应该清晰、简洁、准确。</p><p><strong>示例：</strong></p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
<span class="token key atrule">name</span><span class="token punctuation">:</span> pdf<span class="token punctuation">-</span>processing
<span class="token key atrule">description</span><span class="token punctuation">:</span> 提取PDF文本和表格。在用户上传PDF时使用。
...
<span class="token punctuation">---</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-清晰的指令" tabindex="-1"><a class="header-anchor" href="#_3-清晰的指令" aria-hidden="true">#</a> 3. 清晰的指令</h4><p><strong>原则：</strong> 指令应该详细、可执行、无歧义。</p><p><strong>示例：</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">##</span> 何时使用</span>
<span class="token list punctuation">-</span> 用户上传PDF文件
<span class="token list punctuation">-</span> 需要提取文本或表格
