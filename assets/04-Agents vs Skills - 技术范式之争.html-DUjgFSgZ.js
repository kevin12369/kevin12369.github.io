...
工具执行
  ↓
结果整合
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>优势：</strong></p><ol><li><strong>通用性强</strong>：可以处理各种类型的任务</li><li><strong>自主决策</strong>：Agent可以自主选择合适的工具</li><li><strong>灵活性高</strong>：可以动态组合不同工具</li></ol><p><strong>劣势：</strong></p><ol><li><strong>Token消耗大</strong>：所有工具的元数据都需要加载到上下文</li><li><strong>认知负担重</strong>：Agent需要在大量工具中进行选择</li><li><strong>可预测性差</strong>：自主决策可能导致不确定性</li><li><strong>维护成本高</strong>：工具数量越多，维护越复杂</li></ol><h3 id="_1-2-skills范式-确定性-渐进加载" tabindex="-1"><a class="header-anchor" href="#_1-2-skills范式-确定性-渐进加载" aria-hidden="true">#</a> 1.2 Skills范式：确定性 + 渐进加载</h3><p><strong>核心理念：</strong> 通过模块化的技能（Skills），按需加载AI的能力，实现高效、可预测的AI行为。</p><p><strong>典型特征：</strong></p><ul><li>确定性强：Skills的行为是预定义的</li><li>渐进加载：按需加载，节省Token</li><li>模块化：Skills可以组合和复用</li></ul><p><strong>技术架构：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>AI Agent
  ↓
...
不影响主系统
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第三部分-deep-agents的实践" tabindex="-1"><a class="header-anchor" href="#第三部分-deep-agents的实践" aria-hidden="true">#</a> 第三部分：Deep Agents的实践</h2><h3 id="_3-1-从tool到skill的转变" tabindex="-1"><a class="header-anchor" href="#_3-1-从tool到skill的转变" aria-hidden="true">#</a> 3.1 从Tool到Skill的转变</h3><p><strong>核心思想：</strong> 把&quot;动作&quot;从Tool卸载到文件系统。</p><p><strong>传统方式（Tool）：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>每个操作一个Tool
- readFile Tool
- writeFile Tool
- executeCommand Tool
- ...
...
- filesystem Tools
- 通过Skills组织能力
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-文件系统作为通用工具" tabindex="-1"><a class="header-anchor" href="#_3-2-文件系统作为通用工具" aria-hidden="true">#</a> 3.2 文件系统作为通用工具</h3><p><strong>核心概念：</strong> Agent不再依赖数百个定制工具，而是被赋予一台&quot;电脑&quot;。</p><p><strong>能力：</strong></p><ul><li>读文件</li><li>写文件</li><li>写脚本</li><li>跑命令</li></ul><p><strong>优势：</strong></p><ul><li>工具数量少</li><li>灵活性高</li><li>接近人类开发者</li></ul><h3 id="_3-3-能力迁移而非工具升级" tabindex="-1"><a class="header-anchor" href="#_3-3-能力迁移而非工具升级" aria-hidden="true">#</a> 3.3 能力迁移而非工具升级</h3><p><strong>核心区别：</strong></p><ul><li>Skills不是Tools的升级</li><li>Skills是一种新的能力组织方式</li><li>Skills强调能力的迁移和复用</li></ul><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Tool：一个特定的功能
Skill：一个可复用的能力模块
...
方式：使用Skills范式
原因：任务明确，需要确定性和高效率
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-混合模式的可能" tabindex="-1"><a class="header-anchor" href="#_4-3-混合模式的可能" aria-hidden="true">#</a> 4.3 混合模式的可能</h3><p><strong>核心理念：</strong> 结合Agent和Skills的优势，构建更强大的AI系统。</p><p><strong>架构设计：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>AI Agent（自主决策）
  ↓
Skills模块（确定性执行）
  ↓
工具层（底层能力）
...
└─ 否 → 需要自主决策？
    ├─ 是 → 使用Agent
    └─ 否 → 使用Skills
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>选择建议：</strong></p><ol><li><strong>简单、明确的任务</strong> → Skills</li><li><strong>复杂、不确定的任务</strong> → Agent</li><li><strong>需要确定性和效率的任务</strong> → Skills</li><li><strong>需要灵活性和创造性的任务</strong> → Agent</li><li><strong>大型、复杂的项目</strong> → 混合模式</li></ol><h2 id="第五部分-实际案例" tabindex="-1"><a class="header-anchor" href="#第五部分-实际案例" aria-hidden="true">#</a> 第五部分：实际案例</h2><h3 id="_5-1-案例1-pdf处理系统" tabindex="-1"><a class="header-anchor" href="#_5-1-案例1-pdf处理系统" aria-hidden="true">#</a> 5.1 案例1：PDF处理系统</h3><p><strong>需求：</strong> 提取PDF文件中的文本和表格，生成结构化数据。</p><p><strong>方案A：使用Agent范式</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Agent + Tools：
- PDF读取Tool
- 文本提取Tool
- 表格解析Tool
- 数据格式化Tool
...
- 结果确定
- 易于维护
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>对比：</strong></p><table><thead><tr><th>指标</th><th>Agent范式</th><th>Skills范式</th></tr></thead><tbody><tr><td>Token消耗</td><td>8,000</td><td>2,500</td></tr><tr><td>准确率</td><td>85%</td><td>99%</td></tr><tr><td>维护成本</td><td>高</td><td>低</td></tr><tr><td>开发时间</td><td>2周</td><td>3天</td></tr></tbody></table><p><strong>结论：</strong> 对于这个明确的任务，Skills范式更合适。</p><h3 id="_5-2-案例2-智能客服系统" tabindex="-1"><a class="header-anchor" href="#_5-2-案例2-智能客服系统" aria-hidden="true">#</a> 5.2 案例2：智能客服系统</h3><p><strong>需求：</strong> 处理用户咨询，提供智能回复，支持多轮对话。</p><p><strong>方案A：使用Agent范式</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Agent + Tools：
- 对话管理Tool
- 知识库查询Tool
- 意图识别Tool
- 回复生成Tool
...
- 需要预定义
- 难以适应新场景
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>对比：</strong></p><table><thead><tr><th>指标</th><th>Agent范式</th><th>Skills范式</th></tr></thead><tbody><tr><td>灵活性</td><td>高</td><td>中</td></tr><tr><td>准确率</td><td>75%</td><td>90%</td></tr><tr><td>维护成本</td><td>高</td><td>低</td></tr><tr><td>开发时间</td><td>3周</td><td>2周</td></tr></tbody></table><p><strong>结论：</strong> 对于这个需要灵活性和适应性的任务，Agent范式更合适。</p><h3 id="_5-3-案例3-代码生成与审查系统" tabindex="-1"><a class="header-anchor" href="#_5-3-案例3-代码生成与审查系统" aria-hidden="true">#</a> 5.3 案例3：代码生成与审查系统</h3><p><strong>需求：</strong> 生成代码，进行代码审查，提供改进建议。</p><p><strong>方案：混合模式</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Agent：
- 分析需求
- 设计架构
- 规划生成步骤
...
3. Agent调用代码审查Skill
4. Agent整合结果
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>优势：</strong></p><ol><li>Agent提供灵活性和自主性</li><li>Skills提供确定性和效率</li><li>结合两者的优势</li></ol><p><strong>对比：</strong></p><table><thead><tr><th>指标</th><th>纯Agent</th><th>纯Skills</th><th>混合模式</th></tr></thead><tbody><tr><td>灵活性</td><td>高</td><td>低</td><td>高</td></tr><tr><td>效率</td><td>低</td><td>高</td><td>高</td></tr><tr><td>准确率</td><td>70%</td><td>95%</td><td>92%</td></tr><tr><td>维护成本</td><td>高</td><td>低</td><td>中</td></tr></tbody></table><p><strong>结论：</strong> 对于这个复杂的任务，混合模式最佳。</p><h2 id="第六部分-最佳实践" tabindex="-1"><a class="header-anchor" href="#第六部分-最佳实践" aria-hidden="true">#</a> 第六部分：最佳实践</h2><h3 id="_6-1-设计skills的准则" tabindex="-1"><a class="header-anchor" href="#_6-1-设计skills的准则" aria-hidden="true">#</a> 6.1 设计Skills的准则</h3><h4 id="_1-单一职责" tabindex="-1"><a class="header-anchor" href="#_1-单一职责" aria-hidden="true">#</a> 1. 单一职责</h4><p><strong>原则：</strong> 每个Skill只负责一个明确的功能。</p><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>❌ 错误：文件处理Skill（包含读、写、解析等）
✅ 正确：PDF读取Skill、表格解析Skill、数据格式化Skill
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-明确的元数据" tabindex="-1"><a class="header-anchor" href="#_2-明确的元数据" aria-hidden="true">#</a> 2. 明确的元数据</h4><p><strong>原则：</strong> 元数据应该清晰、简洁、准确。</p><p><strong>示例：</strong></p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>---
name: pdf-processing
description: 提取PDF文本和表格。在用户上传PDF时使用。
version: 1.0.0
author: Your Name
---
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-清晰的指令" tabindex="-1"><a class="header-anchor" href="#_3-清晰的指令" aria-hidden="true">#</a> 3. 清晰的指令</h4><p><strong>原则：</strong> 指令应该详细、可执行、无歧义。</p><p><strong>示例：</strong></p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>## 何时使用
- 用户上传PDF文件
- 需要提取文本或表格
...
- JSON格式
- 包含文本和表格数据
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-可测试的资源" tabindex="-1"><a class="header-anchor" href="#_4-可测试的资源" aria-hidden="true">#</a> 4. 可测试的资源</h4><p><strong>原则：</strong> 资源应该独立、可测试、可维护。</p><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>skills/pdf-processing/
├── SKILL.md
├── pdfextract.py      # 可独立测试
...
└── test/              # 测试用例
    ├── test_pdfextract.py
    └── test_tableparser.py
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-2-构建agent的准则" tabindex="-1"><a class="header-anchor" href="#_6-2-构建agent的准则" aria-hidden="true">#</a> 6.2 构建Agent的准则</h3><h4 id="_1-明确的目标" tabindex="-1"><a class="header-anchor" href="#_1-明确的目标" aria-hidden="true">#</a> 1. 明确的目标</h4><p><strong>原则：</strong> Agent应该有明确的目标和范围。</p><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>❌ 错误：万能Agent（什么都能做）
✅ 正确：代码审查Agent（专注于代码审查）
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-合理的工具选择" tabindex="-1"><a class="header-anchor" href="#_2-合理的工具选择" aria-hidden="true">#</a> 2. 合理的工具选择</h4><p><strong>原则：</strong> 选择合适的工具，避免工具堆砌。</p><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>❌ 错误：提供100+个工具
✅ 正确：提供10-20个核心工具
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-清晰的工作流" tabindex="-1"><a class="header-anchor" href="#_3-清晰的工作流" aria-hidden="true">#</a> 3. 清晰的工作流</h4><p><strong>原则：</strong> Agent的工作流应该清晰、可理解、可维护。</p><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. 分析需求
2. 选择工具
3. 执行任务
4. 验证结果
5. 输出结果
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-3-混合模式的设计" tabindex="-1"><a class="header-anchor" href="#_6-3-混合模式的设计" aria-hidden="true">#</a> 6.3 混合模式的设计</h3><h4 id="_1-明确的分工" tabindex="-1"><a class="header-anchor" href="#_1-明确的分工" aria-hidden="true">#</a> 1. 明确的分工</h4><p><strong>原则：</strong> Agent负责决策和规划，Skills负责执行。</p><p><strong>示例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Agent：
- 分析需求
- 选择Skills
- 规划执行步骤
