import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,d as s,o as l}from"./app-ry7nqkQQ.js";const a={};function d(r,e){return l(),n("div",null,[...e[0]||(e[0]=[s(`<h1 id="前端性能优化总结-2025版" tabindex="-1"><a class="header-anchor" href="#前端性能优化总结-2025版" aria-hidden="true">#</a> 前端性能优化总结（2025版）</h1><h2 id="_2025年前端性能优化趋势" tabindex="-1"><a class="header-anchor" href="#_2025年前端性能优化趋势" aria-hidden="true">#</a> 2025年前端性能优化趋势</h2><ul><li><strong>Core Web Vitals 成为核心指标</strong>：LCP、FID、CLS</li><li><strong>性能预算</strong>：建立性能监控和预算机制</li><li><strong>性能优化自动化</strong>：CI/CD 集成性能测试</li><li><strong>WebAssembly 应用</strong>：提高计算密集型任务性能</li><li><strong>边缘计算</strong>：CDN 边缘渲染</li></ul><h2 id="性能指标" tabindex="-1"><a class="header-anchor" href="#性能指标" aria-hidden="true">#</a> 性能指标</h2><h3 id="_1-core-web-vitals" tabindex="-1"><a class="header-anchor" href="#_1-core-web-vitals" aria-hidden="true">#</a> 1. Core Web Vitals</h3><p><strong>LCP (Largest Contentful Paint)</strong>：最大内容绘制</p><ul><li>衡量主要内容加载速度</li><li>目标：&lt; 2.5s</li></ul><p><strong>FID (First Input Delay)</strong>：首次输入延迟</p><ul><li>衡量交互响应速度</li><li>目标：&lt; 100ms</li></ul><p><strong>CLS (Cumulative Layout Shift)</strong>：累积布局偏移</p><ul><li>衡量视觉稳定性</li><li>目标：&lt; 0.1</li></ul><h3 id="_2-其他重要指标" tabindex="-1"><a class="header-anchor" href="#_2-其他重要指标" aria-hidden="true">#</a> 2. 其他重要指标</h3><ul><li><strong>FCP (First Contentful Paint)</strong>：首次内容绘制</li><li><strong>TTI (Time to Interactive)</strong>：可交互时间</li><li><strong>TBT (Total Blocking Time)</strong>：总阻塞时间</li><li><strong>Speed Index</strong>：速度指数</li></ul><h2 id="加载性能优化" tabindex="-1"><a class="header-anchor" href="#加载性能优化" aria-hidden="true">#</a> 加载性能优化</h2><h3 id="_3-资源加载优化" tabindex="-1"><a class="header-anchor" href="#_3-资源加载优化" aria-hidden="true">#</a> 3. 资源加载优化</h3><p><strong>减少 HTTP 请求</strong>：</p><ul><li>合并 CSS、JS 文件</li><li>使用雪碧图或 Icon Font</li><li>使用 Data URI（小文件）</li></ul><p><strong>使用 CDN</strong>：</p><ul><li>静态资源托管到 CDN</li><li>就近访问，减少延迟</li></ul><p><strong>预加载和预连接</strong>：</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>&lt;!-- 预连接 --&gt;
