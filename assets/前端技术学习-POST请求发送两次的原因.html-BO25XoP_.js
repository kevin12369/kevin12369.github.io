import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,a,o as d}from"./app-BnzN889n.js";const s={};function l(r,e){return d(),n("div",null,[...e[0]||(e[0]=[a(`<h1 id="前端技术学习-post请求发送两次的原因-2025版" tabindex="-1"><a class="header-anchor" href="#前端技术学习-post请求发送两次的原因-2025版" aria-hidden="true">#</a> 前端技术学习 - POST请求发送两次的原因（2025版）</h1><h2 id="问题背景" tabindex="-1"><a class="header-anchor" href="#问题背景" aria-hidden="true">#</a> 问题背景</h2><p>在开发过程中，你可能会发现某些 POST 请求在浏览器中发送了两次：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>OPTIONS /api/data
POST /api/data
